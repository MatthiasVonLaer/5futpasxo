...
<table class="sen-sub-linio">
    ...
    <tr>
        <td><a href="#Sinharadado">Sinhardado</a></td>
        <td>-</td>
        <td>+3 VP, aldone +1 VP po VK ekde la 4a VK</td>
    </tr>
    <tr class="supra-linio">
        <td><a href="#Superfortigaj-sorĉoj">Superfortigaj sorĉoj</a></td>
        <td>-</td>
        <td>Bono de +2 por sorĉniveloĵetoj por superi sorĉreziston</td>
    </tr>
    <tr class="malsupra-linio">
        <td class="desxovo-1"><a href="#Superfortigaj-sorĉoj-potencaj">Superfortigaj sorĉoj potencaj</a></td>
