...
<title>Resanigo</title>
<h4 class="tradukinda" id="resanigo">Resanigo</h4>
<?php tradukinda_sorcxo("heal.html#heal"); ?>

<h4 class="tradukinda" id="resanigo-amasa">Resanigo amasa</h4>
<?php tradukinda_sorcxo("heal.html#heal-mass"); ?>
